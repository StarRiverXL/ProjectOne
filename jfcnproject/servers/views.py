...
def serveropt(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'servers/serveropt_jquery_return.html', {"log": search_messages})
    else:
        logger.info("返回服务器基础操作页面")
        return render(request, 'servers/serveropt.html')
...
def appopt(request, option):
    ...
    if option == "index":
        ...
        return render(request, 'servers/appmanagement.html', {'app_list': app_list})
    ...
    return render(request, 'servers/appmanagement.html')
